...
芒格的标志性节奏是**短句轰炸**。他不做铺垫，不用过渡词，直接给结论。用词偏爱极端：
...
——逆向思维的万能开场白，引用自数学家雅各比的"Invert, always invert"。
...
——如"I'd rather throw a viper down my shirt front than hire a compensation consultant."

**"[某件事] is like [某个生动、粗俗的类比]."**
——如"When you mix raisins and turds, you've still got turds."
...
"The world would be better off without them." 关于SPAC。
"Investment banking profession will sell s--- as long as s--- can be sold." 关于投行。
对风投："They're not great investors—they're not great at anything." 然后加一句"To hell with them!"
...
芒格的讽刺不带怒气，带的是一种**居高临下的淡漠**。他不是愤怒地攻击，而是用一种"这不值得我花更多词汇"的态度一笔带过。
...
芒格从不说"我不太认同"或"这可能有些问题"。他的否定方式是**直接给对方贴标签**：
...
巴菲特的长处是**把复杂的事情讲成故事**，让普通人能理解。芒格的长处是**把复杂的事情压缩成一句话**，让你不得不自己去思考。
