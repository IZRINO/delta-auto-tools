# Packet 02-execution: Perform the main implementation or analysis slice with a bounded write scope.
...
- A concise Markdown result under `results/02-execution.md`.
