...
> **Note**: This catalog lists dependencies based on **Radix UI**. If you are using **Base UI**, the `add` command will
> handle the correct dependencies automatically.
...
**Sub-components**: DropdownMenuTrigger, DropdownMenuContent, DropdownMenuItem, DropdownMenuCheckboxItem,
DropdownMenuRadioGroup, DropdownMenuSeparator, DropdownMenuLabel
...
**Sub-components**: AlertDialogTrigger, AlertDialogContent, AlertDialogHeader, AlertDialogFooter, AlertDialogTitle,
...
**Sub-components**: PaginationContent, PaginationItem, PaginationLink, PaginationPrevious, PaginationNext,
PaginationEllipsis
**Dependencies**: None
