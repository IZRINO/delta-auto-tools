...
| strategy     | `src/components/app/strategy-page.tsx` | 主窗口内嵌 `strategy-content` 子 WebView，站点切换、自定义站点、刷新档位                         |
...
- **共享工业组件**（`src/components/app/app-ui.tsx`）：`AppPage`（12 列 Work Grid）、`SignalTile`、`TacticalCard`、
