        ...
        >
            ...
            >
                <div
                    ...
                    className="flex size-full flex-col rounded-[calc(var(--radius-xl)+2px)] border border-sidebar-border bg-sidebar group-data-[variant=floating]:rounded-[calc(var(--radius-xl)+2px)]"
                >
                    {children}
                </div>
            </div>
...
function SidebarInset({className, ...props}: React.ComponentProps<"main">) {
    return (
        <main
            ...
            className={cn(
                "relative flex w-full flex-1 flex-col bg-background md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ms-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ms-2",
                className
            )}
            {...props}
        />
