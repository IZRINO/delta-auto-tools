...
export type AccountPlan = { id: string; qqAccount: string; password: string; enabled: boolean; initialized: boolean; order: number; status: AccountStatus; stations: StationPlan[]; ammoTargets: AmmoTarget[]; lastFailure: AccountFailure | null; loginTrialSignature: string | null };
...
export type LoginStep = "stopGame" | "stopWeGame" | "startWeGame" | "waitLoginChoice" | "openLoginForm" | "inputAccount" | "inputPassword" | "submitLogin" | "waitGameEntry" | "openGameEntry" | "waitLaunchButton" | "launchGame" | "waitGameWindow";
