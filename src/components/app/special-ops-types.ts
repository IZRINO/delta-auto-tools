...
export type LimitedSupplyAccountState = {cycleId: string | null; outcome: LimitedSupplyOutcome; checkedAtMs: number | null; matchedRegion: number | null; matchedColor: [number, number, number] | null; matchedColorIndexes?: number[]; acknowledged: boolean; lastError: string | null};
