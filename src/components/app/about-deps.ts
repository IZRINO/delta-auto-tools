...
export const DEPENDENCIES: Dependency[] = [
  ...
  { name: "@fontsource-variable/jetbrains-mono", kind: "frontend", license: "OFL-1.1", url: "https://fontsource.org/fonts/jetbrains-mono" },
  ...
  { name: "crossbeam-channel", kind: "runtime", license: "MIT/Apache-2.0", url: "https://github.com/crossbeam-rs/crossbeam" },
