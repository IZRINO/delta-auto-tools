...
function sampleSettings(): TimerSettings {
  return {
    ...
    timers: [
      {
        id: "alpha",
        groupId: DEFAULT_TIMER_GROUP_ID,
        name: "测试计时器",
        durationSeconds: 300,
        hotkey: "Ctrl+F2",
        direction: "countdown",
...
describe("timer-utils", () => {
  ...
  it("moves timer items by id while preserving all items", () => {
    const settings = sampleSettings();
    settings.timers = [
      { id: "a", groupId: DEFAULT_TIMER_GROUP_ID, name: "A", durationSeconds: 1, hotkey: "F1", direction: "countdown", triggerMode: "press" as const, enabled: true, ignoreRunning: true, segmentCount: null },
      { id: "b", groupId: DEFAULT_TIMER_GROUP_ID, name: "B", durationSeconds: 1, hotkey: "F2", direction: "countup", triggerMode: "press" as const, enabled: true, ignoreRunning: true, segmentCount: null },
      { id: "c", groupId: DEFAULT_TIMER_GROUP_ID, name: "C", durationSeconds: 1, hotkey: "F3", direction: "countdown", triggerMode: "press" as const, enabled: true, ignoreRunning: true, segmentCount: null },
    ];
  ...
  it("sizes display height for four timers without overflow", () => {
    ...
    settings.timers = [
      { id: "a", groupId: DEFAULT_TIMER_GROUP_ID, name: "A", durationSeconds: 1, hotkey: "F1", direction: "countdown", triggerMode: "press" as const, enabled: true, ignoreRunning: true, segmentCount: null },
      { id: "b", groupId: DEFAULT_TIMER_GROUP_ID, name: "B", durationSeconds: 1, hotkey: "F2", direction: "countdown", triggerMode: "press" as const, enabled: true, ignoreRunning: true, segmentCount: null },
      { id: "c", groupId: DEFAULT_TIMER_GROUP_ID, name: "C", durationSeconds: 1, hotkey: "F3", direction: "countdown", triggerMode: "press" as const, enabled: true, ignoreRunning: true, segmentCount: null },
      { id: "d", groupId: DEFAULT_TIMER_GROUP_ID, name: "D", durationSeconds: 1, hotkey: "F4", direction: "countdown", triggerMode: "press" as const, enabled: true, ignoreRunning: true, segmentCount: null },
    ];
